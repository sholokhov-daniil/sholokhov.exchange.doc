...
import {
  ...
  modifBefureUpdate
} from "@/data/codes/php/target/import/enum/value";
...
const data = reactive({
  tableContents: [
    ...
    },
    {
      ...
      children: [
        {
          title: 'onBeforeUFEnumerationUpdate',
          hash: 'before-update',
        },
        {
          title: 'onAfterUFEnumerationUpdate',
          hash: 'after-update'
        },
        {          title: 'onBeforeUFEnumerationAdd',
          hash: 'before-add'
        },
        {
...
<template>
  <card-container>
    ...
    <p>
      Класс: <api-link path="classes/Sholokhov-Exchange-Target-UserFields-Enumeration.html">Enumeration</api-link>
      <br>
  ...
  <card-container>
    ...
    <table-block>
      ...
      <tr>
        ...
        <td>string</td>
        <td>Нет</td>
        <td>Сущность в которую производится импорт</td>
      </tr>
      <tr>
        <td>property_code</td>
        <td>Да</td>
  ...
  <card-container>
    <template #header>
      <h3 id="before-update">onBeforeUFEnumerationUpdate</h3>
    </template>
  ...
  <card-container>
    <template #header>
      <h3 id="after-update">onAfterUFEnumerationUpdate</h3>
    </template>
  ...
  <card-container>
    <template #header>
      <h3 id="before-add">onBeforeUFEnumerationAdd</h3>
    </template>
  ...
  <card-container>
    <template #header>
      <h3 id="after-add">onAfterUFEnumerationAdd</h3>
    </template>
